...
RDEPEND="
	...
	syntax? (
		...
		>=dev-libs/tree-sitter-python-0.23.0[${PYTHON_USEDEP}]
		>=dev-libs/tree-sitter-markdown-0.3.0[${PYTHON_USEDEP}]
		>=dev-libs/tree-sitter-json-0.24.0[${PYTHON_USEDEP}]
		>=dev-libs/tree-sitter-html-0.23.0[${PYTHON_USEDEP}]
		>=dev-libs/tree-sitter-css-0.23.0[${PYTHON_USEDEP}]
		>=dev-libs/tree-sitter-javascript-0.23.0[${PYTHON_USEDEP}]
		>=dev-libs/tree-sitter-rust-0.23.0[${PYTHON_USEDEP}]
		>=dev-libs/tree-sitter-go-0.23.0[${PYTHON_USEDEP}]
		>=dev-libs/tree-sitter-regex-0.24.0[${PYTHON_USEDEP}]
		>=dev-libs/tree-sitter-java-0.23.0[${PYTHON_USEDEP}]
		>=dev-libs/tree-sitter-bash-0.23.0[${PYTHON_USEDEP}]
	)
"
#		>=dev-libs/tree-sitter-toml-0.6.0[${PYTHON_USEDEP}]
#		>=dev-libs/tree-sitter-yaml-0.6.0[${PYTHON_USEDEP}]
#		>=dev-libs/tree-sitter-xml-0.7.0[${PYTHON_USEDEP}]
#		>=dev-libs/tree-sitter-sql-0.3.11[${PYTHON_USEDEP}]
